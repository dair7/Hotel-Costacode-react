...
export default class ApiService {
    ...
    static async getAllUsers() {
        ...
        return response.data?.userList || []; // ✅ extrae la lista correctamente
    }
    ...
    static async getUserById(userId) {
        ...
        // Retornamos directamente la propiedad user que contiene los datos completos
    ...
    static async sendEmail(to, subject, body) {
        const response = await axios.post(`${this.BASE_URL}/api/email/send`, {
            to,
            subject,
            body
        }, {
        ...
        /** This updates the logged-in user's profile */
    static async updateMyProfile(updateRequest) {
        const response = await axios.put(
            `${this.BASE_URL}/users/update-me`,
            updateRequest,
            {
                headers: this.getHeader()
            }
    ...
    /* Este método confirma una reserva */
    static async confirmBooking(bookingId) {
        const result = await axios.put(`${this.BASE_URL}/bookings/confirm/${bookingId}`, null, {
            headers: this.getHeader()
        });
        return result.data;
    }
...
static async deleteMe() {
    const response = await axios.delete(`${this.BASE_URL}/users/delete-me`, {
        headers: this.getHeader()
    });
    return response.data;
}
