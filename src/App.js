...
import SendReminderPage from './component/admin/SendReminderPage';
      ...
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <div style={{ flex: 1 }}>
          <Routes>
            ...
            <Route path="/admin/user/:userId" element={<AdminRoute element={<UserDetailsPage/>} />} />
            <Route path="/admin/send-reminder/:userId/:bookingId" element={<AdminRoute element={<SendReminderPage/>} />} />
